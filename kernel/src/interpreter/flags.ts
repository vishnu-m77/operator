const display = {
  ...
  snippet: `The process is not displayed directly to the user, the user instead only sees that a tool call has taken place. Use for background tasks where you need the information for a task, but the user doesn't need to see it, or where you will summarize it yourself. (E.g. conducting a web search)`,
};
